...
_PATTERN: Final[re.Pattern[str]] = re.compile(
    r"\b(?:v-?bucks|robux|gift card|amazon card|venmo|cashapp|paypal|"
    r"send you money|buy you|i'?ll send you)\b",
    re.IGNORECASE,
)


class GiftOfferingPattern:
    name = "gift_offering"
    signal_kind = SignalKind.GIFT_OFFERING
