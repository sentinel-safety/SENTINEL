...
async def test_ingestion_p99_under_200ms_with_memory_enabled(
            ...
            for i in range(1000):
                ...
                resp = await client.post(
                    ...
                    json={
                        ...
                        "actor_external_id_hash": f"{i:064x}",
                        "target_actor_external_id_hashes": [f"{(i + 1):064x}"],
                        "event_type": "message",
    ...
    assert p99 < 200.0, f"p99 was {p99:.1f}ms"
