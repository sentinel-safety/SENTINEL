...
def test_critical_returns_suspend_and_mandatory_report() -> None:
    actions = recommend_actions(ResponseTier.CRITICAL, _config())
    kinds = [a.kind for a in actions]
    assert ActionKind.SUSPEND in kinds
    assert ActionKind.MANDATORY_REPORT in kinds
